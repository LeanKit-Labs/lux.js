	...
	function processGeneration(generation, action) {
		...
		generation.map(function (store) {
			var data = Object.assign({
				deps: _lodash2.default.pick(_this.stores, store.waitFor) // eslint-disable-line
			}, action);
					...
					dispatching: {
						_onEnter: function _onEnter(luxAction) {
							...
							if (luxAction.generations.length) {
								...
								_this2.transition(luxAction, "notifying");
							} else {
								_this2.transition(luxAction, "nothandled");
							}
						},
