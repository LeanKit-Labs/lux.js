...
(function(root, factory) {
  ...
  var Dispatcher = function Dispatcher() {
    ...
    $traceurRuntime.superConstructor($Dispatcher).call(this, {
      ...
      states: {
          ...
          _onEnter: function(luxAction) {
            ...
            if (luxAction.generations.length) {
              (function() {
                var $__2 = 0,
                    $__3 = [];
                for (var $__4 = luxAction.generations[$traceurRuntime.toProperty(Symbol.iterator)](),
                    $__5; !($__5 = $__4.next()).done; ) {
                  var generation = $__5.value;
                  $__3[$__2++] = processGeneration.call(luxAction, generation, luxAction.action);
                }
                return $__3;
              }());
        ...
        notifying: {_onEnter: function(luxAction) {
            dispatcherChannel.publish("notify", {action: luxAction.action});
          }},
        nothandled: {}
      },
  ...
  ($traceurRuntime.createClass)(Dispatcher, {
    handleActionDispatch: function(data) {
      "use strict";
    ...
    registerStore: function(storeMeta) {
      "use strict";
