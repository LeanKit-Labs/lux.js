...
(function(root, factory) {
  ...
  function merge() {
    ...
    while (nextSource = sources.shift()) {
      for (var $__5 = entries(nextSource)[$traceurRuntime.toProperty(Symbol.iterator)](),
  ...
  var Store = function Store() {
    ...
    for (var opt = [],
        $__9 = 0; $__9 < arguments.length; $__9++)
      opt[$__9] = arguments[$__9];
    var options = merge.apply(null, $traceurRuntime.spread(opt));
